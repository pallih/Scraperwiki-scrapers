...
def get_proxy():
    ...
    format: {'http':ip:port '''
    proxieslist = json.loads(scraperwiki.scrape('http://api.proxyswitcheroo.com/v1/proxies?format=json&api_key='+qsenv['PROXY_API_KEY']+'&num_records=10&proxy_type=T&speed_rating=5&fresh_hours=3'))
    proxies = []
